<?php
 include "conexao.php";
	...
	$sql1="INSERT INTO dados_pessoais VALUES('$vcpf','$vnome','$vsexo','$vrg','$vdatanas','$vestadocivil','$vendereco','$vnumero','$vbairro','$vpontoref','$vcidade','$vcep','$vtelefone','$vtelefone2','$vtemporesi','$vtipo','$vvalor')";
